...
- (instancetype)init
{
    ...
    if (self)
    {
        ...
        self.subTitleY = 77.0f;
        self.subTitleHeight = 90.0f;
        self.circleIconHeight = 20.0f;
        self.windowWidth = [[UIScreen mainScreen] bounds].size.width-70;
        self.windowHeight = 182;
        ...
        // Font
        _titleFontFamily = @"SourceSansPro-SemiBold";
        _bodyTextFontFamily = @"SourceSansPro-Regular";
        _buttonsFontFamily = @"SourceSansPro-SemiBold";
...
- (void)viewWillLayoutSubviews
{
    ...
    {
        btn.frame = CGRectMake(0, _windowHeight-btn.buttonSize.height, _windowWidth, btn.buttonSize.height);
        y += btn.buttonSize.height;

        // Update view height
        self.windowHeight += btn.buttonSize.height;
    }
}
...
-(SCLAlertViewResponder *)showTitle:(UIViewController *)vc image:(UIImage *)image color:(UIColor *)color title:(NSString *)title subTitle:(NSString *)subTitle duration:(NSTimeInterval)duration completeText:(NSString *)completeText style:(SCLAlertViewStyle)style
{
    ...
    switch (style)
    {
        ...
        case Notice:
            viewColor = UIColorFromRGB(0xFD6A91);
            iconImage = image;
            break;
    ...
    for (SCLButton *btn in _buttons)
    {
        ...
        btn.defaultBackgroundColor = [UIColor colorWithRed:0.97 green:0.97 blue:0.97 alpha:1];
...
{
    [self showTitle:vc image:[UIImage imageNamed:@"icon-heart"] color:nil title:title subTitle:subTitle duration:duration completeText:closeButtonTitle style:Notice];
}
